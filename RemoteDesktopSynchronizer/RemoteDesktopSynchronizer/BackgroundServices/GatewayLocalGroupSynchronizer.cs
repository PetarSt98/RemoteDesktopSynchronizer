...
namespace RemoteDesktopCleaner.BackgroundServices
{
    public class GatewayLocalGroupSynchronizer : IGatewayLocalGroupSynchronizer
    {
        ...
        {
            LoggerSingleton.General.Info(serverName, $"There are {changedLocalGroups.LocalGroupsToAdd.Count + changedLocalGroups.LocalGroupsToUpdate.Count} groups to synchronize.");
